...
/**
 * Chains providers and combines every matching policy with AND semantics.
 *
 ...
 * - {@see AllOf} when multiple policies are found.
 *
 ...
 */
final class AllOfPolicyProvider implements PolicyProviderInterface
{
